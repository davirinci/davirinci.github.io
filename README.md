...
- **[Site Structure](documentation/SITE_STRUCTURE.md)** - Directory map and where to add new pages/assets
- **[Agent/Developer Context](AGENTS.md)** - Master implementation contract and self-update protocol
